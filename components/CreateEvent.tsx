...
import { ArrowLeft, MapPin, ChevronDown, Plus, Calendar, LogOut } from "lucide-react"
                ...
                <div className="flex items-center gap-4">
                    ...
                    {isAuthenticated ? (
                        <div className="relative">
                            <div
                                className="w-8 h-8 rounded-full bg-teal-500 flex items-center justify-center text-xs font-bold text-black cursor-pointer ring-2 ring-white/10 hover:ring-white/20 transition-all"
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {upcomingEvents.map(event => (
                                    <div key={event.id} className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-4 flex gap-4 items-center">
                                        <div className="w-16 h-16 rounded-xl flex items-center justify-center text-2xl bg-gray-800">
                ...
                <div className="pt-24 pb-20 px-4 md:px-8 max-w-5xl mx-auto">
                    ...
                    <div className="mb-12">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <Button variant="ghost" size="sm" className="text-gray-400 hover:text-white h-8 hover:bg-white/5" onClick={() => router.push('/create')}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div className="bg-[#1a1a1a] border border-white/5 rounded-2xl p-4 hover:border-white/10 transition-colors cursor-pointer group">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-full bg-teal-500 flex-shrink-0" />
                                    <div>
                ...
                <div className="pt-24 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide max-w-full md:max-w-xl">
                            {["All", "Tech", "Founders", "AI", "Design", "Product", "Social"].map((tag, i) => (
                                <button
                                    key={tag}
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { title: "Tech Mixer: December Edition", date: "Dec 14", time: "6:00 PM", location: "City Center", color: "bg-purple-500" },
                                { title: "AI Builders Meetup", date: "Dec 15", time: "10:00 AM", location: "Tech Hub", color: "bg-teal-500" },
                                { title: "Founders Networking", date: "Dec 16", time: "5:30 PM", location: "Downtown", color: "bg-orange-500" },
                                { title: "Design Systems Workshop", date: "Dec 18", time: "2:00 PM", location: "Creative Space", color: "bg-blue-500" }
                            ].map((event, i) => (
                                <div key={i} className="group cursor-pointer">
                                    <div className={`aspect-[4/3] rounded-2xl ${event.color} relative overflow-hidden mb-4`}>
