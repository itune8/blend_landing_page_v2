...
function PricingCard({ plan, isYearly, onGetStarted }: { plan: PricingPlan; isYearly: boolean; onGetStarted: () => void }) {
    ...
    return (
        <motion.div
            className={cn(
                "bg-white dark:bg-gray-90 border border-gray-20 dark:border-gray-80 rounded-xl p-5",
        ...
        <div className="min-h-screen grid-pattern">
            ...
            >
                ...
                <p className="mt-6 text-xl text-muted-foreground max-w-xl mx-auto">
                    Use Blend for free with unlimited events and guests. Upgrade for more invitations, 0% platform fee, and more.
                </p>

                {/* Toggle */}
                <div className="inline-flex mt-8 bg-gray-10 dark:bg-gray-90 rounded-lg p-1">
                    <motion.button
                        className={cn(
                            "px-4 py-1.5 text-sm font-medium rounded-md transition-all",
                            !isYearly
                                ? "bg-white dark:bg-gray-80 text-foreground shadow-sm"
            ...
            <div className="max-w-4xl mx-auto mt-12 px-4 grid md:grid-cols-2 gap-6">
                {plans.map((plan, index) => (
                    ...
                    >
                        <PricingCard plan={plan} isYearly={isYearly} onGetStarted={() => router.push('/create-event')} />
                    </motion.div>
                ))}
            </div>

            {/* Enterprise card - solid background, no glassmorphism */}
            <motion.div
            ...
            >
                <div className="bg-white dark:bg-gray-90 border border-gray-20 dark:border-gray-80 rounded-xl p-5">
                    ...
                    {/* Features marquee */}
                    <div className="mt-4 -mx-5 -mb-5 px-5 py-3 bg-gray-10 dark:bg-gray-100 rounded-b-xl overflow-hidden">
                        <motion.div
