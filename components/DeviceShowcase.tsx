...
// Background gradient matching main page - optimized for mobile
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
            ...
            >
                ...
                {/* 3-Device Layout */}
                <div className="relative flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-10 lg:gap-12">
                    {/* iPad - Left */}
                    <motion.div
                    ...
                    >
                        <Link href="/discover" className="block">
                            {/* iPad Frame */}
                            <div className="relative w-[200px] md:w-[200px] lg:w-[240px] aspect-[3/4] bg-gray-900 rounded-[24px] md:rounded-[32px] p-3 md:p-4 shadow-2xl border-4 md:border-8 border-gray-800">
                    ...
                    >
                        <Link href="/calendars" className="block">
                            ...
                            <div className="relative">
                                {/* Screen */}
                                <div className="relative w-[300px] md:w-[400px] lg:w-[500px] aspect-[16/10] bg-gray-900 rounded-t-[16px] md:rounded-t-[24px] p-2 md:p-3 shadow-2xl border-4 md:border-8 border-gray-800 border-b-0">
                                ...
                                {/* MacBook Base */}
                                <div className="w-[320px] md:w-[430px] lg:w-[540px] h-2 md:h-3 bg-gradient-to-b from-gray-700 to-gray-800 rounded-b-lg mx-auto shadow-lg" />
                            </div>
                        </Link>
                    </motion.div>
                    ...
                    >
                        <Link href="/events" className="block">
                            {/* iPhone Frame */}
                            <div className="relative w-[160px] md:w-[140px] lg:w-[160px] aspect-[9/19.5] bg-gray-900 rounded-[28px] md:rounded-[40px] p-2 md:p-3 shadow-2xl border-4 md:border-8 border-gray-800">
