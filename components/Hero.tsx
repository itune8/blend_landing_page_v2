            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-4">
                ...
                >
                    ...
                    >
                        ...
                        <span className="block bg-gradient-to-r from-teal-400 via-teal-500 to-cyan-500 bg-clip-text text-transparent">
                            Real Experiences.
                        </span>
                ...
                {/* Phone mockup */}
                <div className="flex-shrink-0 w-full lg:w-[631px] h-auto lg:h-[663px] flex items-center justify-center lg:-mr-10 perspective-1000">
                    <PhoneMockup />
                </div>
            </div>
        </section>
