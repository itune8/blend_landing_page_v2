    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {/* Deep shadow for pop-out effect - enhanced */}
                    <motion.div
                    ...
                    {/* Main sphere body - enhanced shadows */}
                    <motion.div
                    ...
                    >
                        ...
                        {/* 3D Convex curvature overlay - stronger edge darkening */}
                        <motion.div
                        ...
                        {/* Secondary curved vignette for deeper inward effect */}
                        <motion.div
                            className="absolute inset-0 rounded-full pointer-events-none"
                            style={{
                                background: `
                        ...
                        {/* Inner shadow ring for pronounced 3D curve */}
                        <motion.div
                            className="absolute inset-0 rounded-full pointer-events-none"
                            style={{
                                boxShadow: `
                        ...
                        {/* Primary specular highlight - large soft glow */}
                        <motion.div
                        ...
                        {/* Secondary sharp specular point */}
                        <motion.div
                            className="absolute rounded-full pointer-events-none"
                            style={{
                                top: highlightY,
                        ...
                        {/* Rim light - bottom edge glow - enhanced */}
                        <motion.div
                            className="absolute inset-0 rounded-full pointer-events-none"
                            style={{
